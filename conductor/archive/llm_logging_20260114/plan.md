...
- [x] Task: Wrap all new logging statements in `#if DEBUG` blocks to prevent logs in production. (Done) e20c3b6
- [x] Task: Refine log formatting with clear headers (e.g., `--- OPENROUTER REQUEST ---`) and separators for readability. (Done) e20c3b6
