...
struct QuickActionButtonsView: View {
    var body: some View {
        HStack(spacing: 8) {
            Link(destination: URL(string: "portio://add")!) {
            ...
            Link(destination: URL(string: "portio://camera")!) {
...
struct PortioWidgetEntryView : View {
...
struct PortioWidget: Widget {
    let kind: String = "PortioWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            PortioWidgetEntryView(entry: entry)
        }
        .configurationDisplayName("Portio Daily")
...
struct PortioWidget_Previews: PreviewProvider {
    static var previews: some View {
        PortioWidgetEntryView(entry: SimpleEntry(date: Date(), calories: 1200, calorieGoal: 2000, protein: 80, proteinGoal: 150, carbs: 150, carbsGoal: 250, fat: 45, fatGoal: 70))
