...
- [x] Task: Create `CalorieWidget`, `ProteinWidget`, `CarbsWidget`, and `FatWidget` structs 55b959e
- [x] Task: Register all new widgets in `CalCalWidgetBundle.swift` 55b959e
- [x] Task: Ensure background colors adapt to system light/dark mode correctly 55b959e
