...
class FoodRepositoryTest {
    ...
    private val fakeNutritionService = object : NutritionService(
        ...
        serperService = com.example.calcal.data.remote.SerperService(okhttp3.OkHttpClient()),
        offService = com.example.calcal.data.remote.OpenFoodFactsService(okhttp3.OkHttpClient())
    ) {
    ...
    private val fakeHealthConnect = object : HealthConnectManager(
        ...
        override suspend fun writeNutrition(item: com.example.calcal.domain.model.FoodItem): String? = null
    }
